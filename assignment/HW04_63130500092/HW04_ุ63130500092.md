...
![Graph 1](https://github.com/messipeam/R-Project/blob/main/Rplot01.png)

### 2.) The bar chart represents the sales average each years.
```
...
![Graph 2](https://github.com/messipeam/R-Project/blob/main/Rplot02.png)
